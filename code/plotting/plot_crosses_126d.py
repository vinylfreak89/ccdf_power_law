...
# Calculate baseline - 126 days = 6 months
baseline_window = 126
...
ax2.plot(df['Date'], df['Baseline'], color='orange', linewidth=2, alpha=0.8, label=f'{baseline_window}d Baseline (6mo)')
...
plt.tight_layout()
plt.savefig('deviation_crosses_126d.png', dpi=300, bbox_inches='tight')
print("✓ Saved deviation_crosses_126d.png")
